...
const dataHome = join(tmpdir(), 'npz-e2e-disable-prod-simple-' + Date.now());
...
try {
  ...
  console.log(JSON.stringify({ headings, mainLength: mainText.length, mainExcerpt: mainText.slice(0,300) }, null, 2));
